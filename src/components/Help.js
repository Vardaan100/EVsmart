  ...
  rows: [
    {
      ...
      content: `After signing in your location will be showed as red marker on the map. To get to any station
    ...
    },
    {
      ...
      content: `To edit profile, click on your name displayed in navbar, after that click on my profile. Inside your profile make changes
    ...
    {
      title: "How to book at any station?",
      content: `After signing in your location will be showed as red marker on the map. To book at any station
      click on marker of any station. In the popup you will get informaion about station provider, there is
      one button provided (book now). After clicking your name and your number will be sent to charging station
      owner. Owner will contact you and will give the updates about station!`,
    },
    {
